...
<!--dialogwork-->
	<link rel="stylesheet" type="text/css" href="../code/codebase/dhtmlxwindows.css">
	<link rel="stylesheet" type="text/css" href="../code/codebase/skins/dhtmlxwindows_dhx_skyblue.css">
	<script src="../code/codebase/dhtmlxcommon.js"></script>
	<script src="../code/codebase/dhtmlxwindows.js"></script>
	<script src="../code/codebase/dhtmlxcontainer.js"></script>
...
<ul id="nav">
	...
	<li class="top"><a id="products" class="top_link"><span class="down"><u>F</u>ile</span></a>
		<ul class="sub">
			...
			<li style="border-bottom: 1px solid #aaa; padding: 0px 0px 3px 0px"><a style="color:;" href=".." onclick="discard();"><img src="../code/layout/icon/test/close-work.png" width="10" height="10" />&nbsp;Close</a></li>
...
<ul id="nav">
	...
	<li class="top"><a id="products" class="top_link"><span class="down"><u>F</u>ile</span></a>
		<ul class="sub">
			...
			<li style="border-bottom: 1px solid #aaa; padding: 0px 0px 3px 0px"><a style="color:;" href=".." onclick="discard();"><img src="../code/layout/icon/test/close-work.png" width="10" height="10" />&nbsp;Tutup</a></li>
...
<div style="margin: 0px 2px 0px 0px;">
						...
						if ($_GET['hal'] == 'en') {
						?>		<!--ini dikirim dengan 'en' untuk english-->
								<iframe id="content_blocks" src="frame.php" style="max-height: 650px"></iframe>
						<?
						}
						else {?><!--default dengan indonesia-->		  
...
<script>
	...
	w1 = dhxWins.createWindow("w1", 700, 40, 440, 465);
	...
	w1.stick();
		...
		w2 = dhxWins.createWindow("w2", 5, 30, 650, 480);
