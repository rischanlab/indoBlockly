...
Blockly.Language.maze_move.DIRECTIONS =
    [['maju', 'moveForward'], ['mundur', 'moveBackward']];
...
Blockly.Language.maze_turnLeft.DIRECTIONS =
    [['kiri', 'turnLeft'], ['kanan', 'turnRight'], ['acak', 'random']];
...
Blockly.Language.maze_isWall.DIRECTIONS =
    [['di depan', 'isWallForward'],
     ['di kiri', 'isWallLeft'],
     ['di kanan', 'isWallRight'],
     ['di belakang', 'isWallBackward']];
...
Blockly.Language.controls_forever = {
  ...
  init: function() {
    this.setColour(120);
    this.appendTitle('Mengulang terus');
    this.appendInput('lakukan', Blockly.NEXT_STATEMENT, 'DO');
    this.setPreviousStatement(true);
