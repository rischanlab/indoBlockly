...
Blockly.Language.controls_if = {
  ...
  category: 'Kontrol', //untuk nama di pilihan menu Control = Kontrol
  ...
  MSG_IF: 'jika', //awalnya if
  MSG_ELSEIF: 'jika lain', //awalnya else if
  MSG_ELSE: 'lain', //awalnya else
  MSG_THEN: 'maka', //awalnya then
...
Blockly.Language.controls_if_if = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('jika'); //awalnya if
...
Blockly.Language.controls_if_elseif = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('jika lain'); //awalnya else if
    this.setPreviousStatement(true);
    this.setNextStatement(true);
...
Blockly.Language.controls_if_else = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('lain'); //awalnya else
    this.setPreviousStatement(true);
...
Blockly.Language.controls_whileUntil = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('ulangi'); //awalnya ('repeat'
    var dropdown = new Blockly.FieldDropdown(this.OPERATORS);
    this.appendTitle(dropdown, 'MODE');
    this.appendInput('', Blockly.INPUT_VALUE, 'BOOL', Boolean);
    this.appendInput('lakukan', Blockly.NEXT_STATEMENT, 'DO'); //awalnya ('do'
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    // Assign 'this' to a variable for use in the tooltip closure below.
    var thisBlock = this;
...
Blockly.Language.controls_whileUntil.OPERATORS =
    [['ketika', 'WHILE'], //awalnya [['while',
     ['sampai', 'UNTIL']]; //awalny [['until',
...
Blockly.Language.controls_for = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('hitung'); //awalnya count
    this.appendInput('dengan syarat', Blockly.LOCAL_VARIABLE, 'VAR').setText('x'); //awalnya ('with',
...
Blockly.Language.controls_forEach = {
  ...
  init: function() {
    this.setColour();
    this.appendTitle('untuk setiap'); //awalnya for each
    this.appendInput('nilai', Blockly.LOCAL_VARIABLE, 'VAR').setText('x'); //awalnya ('item',
...
Blockly.Language.controls_flow_statements = {
  ...
  init: function() {
    ...
    this.appendTitle('dari perulangan'); //awalanya of loop
    this.setPreviousStatement(true);
    this.setTooltip(function() {
...
Blockly.Language.controls_flow_statements.OPERATORS =
    [['keluar', 'BREAK'], ['lanjutkan dengan perulangan berikutnya', 'CONTINUE']];
//atas ini awalnya break out dan , ['continue with next iteration',
