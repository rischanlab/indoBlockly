...
Blockly.Language.procedures_defnoreturn = {
  ...
  init: function() {
    this.setColour(280);
    var name = Blockly.Procedures.findLegalName('prosedur', this); //awalany procedure
    this.appendTitle(new Blockly.FieldTextInput(name, Blockly.Procedures.rename), 'NAME');
    this.appendInput('lakukan', Blockly.NEXT_STATEMENT, 'STACK'); //awalnya ('do'
...
Blockly.Language.procedures_defreturn = {
  ...
  init: function() {
    this.setColour(280);
    var name = Blockly.Procedures.findLegalName('prosedur', this); //awalnya procedure
    this.appendTitle(new Blockly.FieldTextInput(name, Blockly.Procedures.rename), 'NAME');
    this.appendInput('lakukan', Blockly.NEXT_STATEMENT, 'STACK'); //awalnya ('do'
    this.appendInput('kembalikan nilai', Blockly.INPUT_VALUE, 'RETURN', null); //awalnya return
...
Blockly.Language.procedures_callnoreturn = {
  ...
  init: function() {
    this.setColour(290);
    this.appendTitle('panggil'); //awalnya call
    this.appendTitle('prosedur', 'NAME'); //awalnya procedure
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip('Panggil sebuah prosedur tanpa nilai kembali.'); //awalnya Call a procedure with no return value.
  },
...
Blockly.Language.procedures_callreturn = {
  ...
  init: function() {
    ...
    this.setTooltip('panggil prosedur dengan nilai kembali.'); //awalnya Call a procedure with a return value.
  },
