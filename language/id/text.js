...
Blockly.Language.text = {
  // Text value.
  category: 'Teks', //untuk nama di pilihan menu Text = Teks
...
Blockly.Language.text_join = {
  ...
  init: function() {
    this.setColour(220);
    this.appendTitle('buat teks dengan'); //awalnya create text with
...
Blockly.Language.text_length = {
  ...
  init: function() {
    this.setColour(220);
    this.appendInput('panjangnya', Blockly.INPUT_VALUE, 'VALUE', [String, Array]); //awalnya ('length'
...
Blockly.Language.text_isEmpty = {
  ...
  init: function() {
    this.setColour(220);
    this.appendInput('adalah kosong', Blockly.INPUT_VALUE, 'VALUE', [String, Array]); //awalnya ('is empty'
...
Blockly.Language.text_endString = {
  ...
  init: function() {
    ...
    this.appendInput('huruf dalam teks', Blockly.INPUT_VALUE, 'TEXT', String); //awalnya letters in text
...
Blockly.Language.text_indexOf = {
  ...
  init: function() {
    ...
    this.appendInput('terdapat', Blockly.INPUT_VALUE, 'FIND', String); //awalnya occurrence of text
    this.appendInput('dalam teks', Blockly.INPUT_VALUE, 'VALUE', String); //awalnya in text
    this.setInputsInline(true);
...
Blockly.Language.text_charAt = {
  ...
  init: function() {
    this.setColour(220);
    this.appendTitle('huruf'); //awalnya letter
    this.setOutput(true, String);
    this.appendInput('di', Blockly.INPUT_VALUE, 'AT', Number); //awalny at
    this.appendInput('dalam teks', Blockly.INPUT_VALUE, 'VALUE', String); //awalnya in text
    this.setInputsInline(true);
...
Blockly.Language.text_changeCase = {
  ...
  init: function() {
    ...
    var thisBlock = this;
    this.setColour(220);
    this.appendTitle('ubah ke'); //awalnya to
    var menu = new Blockly.FieldDropdown(this.OPERATORS);
...
Blockly.Language.text_changeCase.OPERATORS =
    [['HURUF BESAR', 'UPPERCASE'], //awalnya UPPER CASE
     ['huruf kecil', 'LOWERCASE'], //awalnya lower case
     ['Judul', 'TITLECASE']]; //awalnya Title Case
...
Blockly.Language.text_trim = {
  ...
  init: function() {
    ...
    var thisBlock = this;
    this.setColour(220);
    this.appendTitle('bersihkan sepasi di\t'); //awalnya trim spaces from
    ...
    this.appendTitle('sisi', 'SIDES'); //awalnya sides
...
Blockly.Language.text_trim.OPERATORS =
    [['kedua', 'BOTH'], ['kiri', 'LEFT'], ['kanan', 'RIGHT']];
//awalnya [['both' dan ,['left', dan juga ,['right'
Blockly.Language.text_print = {
  ...
  init: function() {
    this.setColour(220);
    this.appendTitle('cetak ke layar'); //awalnya print
...
Blockly.Language.text_prompt = {
  ...
  init: function() {
    this.setColour(220);
    this.appendTitle('meminta masukan'); //awalnya prompt for
    var menu = new Blockly.FieldDropdown(this.TYPES);
    this.appendTitle(menu, 'TYPE');
    this.appendTitle('dengan pesan'); //awalnya with message
    this.appendTitle(new Blockly.FieldTextInput(''), 'TEXT');
...
Blockly.Language.text_prompt.TYPES = [['teks', 'TEXT'], ['angka', 'NUMBER']];
//awalnya [['text' dan ['number'